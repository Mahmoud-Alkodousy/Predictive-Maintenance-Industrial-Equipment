...
class MockStreamlit:
    ...
    def columns(self, *args): return [self] * args[0]
    def tabs(self, *args): return [self] * len(args[0])
...
if src_path.exists():
    ...
    # Fallback: try parent directory directly
...
async def startup_event():
    ...
    print("=" * 80)
    print("✅ Predictive Maintenance API v4.0.0 - COMPLETE")
